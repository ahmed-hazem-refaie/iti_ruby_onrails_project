...
class ActivitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create activite" do
    assert_difference('Activite.count') do
      post activites_url, params: { activite: { action: @activite.action, user_id: @activite.user_id } }
    end
  ...
  test "should update activite" do
    patch activite_url(@activite), params: { activite: { action: @activite.action, user_id: @activite.user_id } }
