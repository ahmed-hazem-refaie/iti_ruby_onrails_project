...
class OrderdetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orderdetail" do
    assert_difference('Orderdetail.count') do
      post orderdetails_url, params: { orderdetail: { amount: @orderdetail.amount, comment: @orderdetail.comment, item: @orderdetail.item, order_id: @orderdetail.order_id, price: @orderdetail.price, user_id: @orderdetail.user_id } }
    end
  ...
  test "should update orderdetail" do
    patch orderdetail_url(@orderdetail), params: { orderdetail: { amount: @orderdetail.amount, comment: @orderdetail.comment, item: @orderdetail.item, order_id: @orderdetail.order_id, price: @orderdetail.price, user_id: @orderdetail.user_id } }
